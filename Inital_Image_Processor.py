...
def Main(Current_Module, Image_Name):
    ...
    return (width/2 + round(x_feedback)), (height/2 + round(y_feedback)), X, Y

PCBX, PCBY, SensorX, SensorY = Main("MHF1WCSB0005", "2_3_15.png")

print("PCB Stepped Hole Center:", PCBX, PCBY)
print("Calculated Sensor Position:", SensorX, SensorY)  
